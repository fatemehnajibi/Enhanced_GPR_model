...
MIX=MIX(MIX(:,1)~=ss(i),:);
    ...
    SFCclus1=MIX(MIX(:,13)==1,:);
         SFCclus2=MIX(MIX(:,13)==2,:);
    SFCclus3=MIX(MIX(:,13)==3,:);
       SFCclus4=MIX(MIX(:,13)==4,:);

 
 trainingData1=SFCclus1;
 trainingData2=SFCclus2;
 trainingData3=SFCclus3;
 trainingData4=SFCclus4;
...
Yprtrue=[ypred(:,1),ypred(:,3),SFC(1:720,11)]
